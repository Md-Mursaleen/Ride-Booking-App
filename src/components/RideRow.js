        ...
        <TouchableOpacity key={type.id} style={[styles.container, {
            ...
            <View style={{ marginLeft: 35 }}>
                <Text style={styles.titleText}>
                    {type.title}{" "}
                    <Ionicons name="person" size={12} /><Text style={{ fontSize: 14.5 }}>{type.capacity}</Text>
                </Text>
                <Text style={{ fontSize: 13, color: "#5d5d5d" }}>{type.timing}</Text>
            </View>
