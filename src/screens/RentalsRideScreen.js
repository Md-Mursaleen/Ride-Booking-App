        ...
        <View style={styles.container}>
            ...
            <View style={{ marginTop: 20 }}>
                <View style={styles.descriptionContainer}>
                    ...
                    <Text style={styles.descriptionTextStyle}>Keep a car and driver for up to 12 hours</Text>
                </View>
                <View style={styles.descriptionContainer}>
                    <MaterialIcons name="work" size={18} color="black" />
                    <View>
                        <Text style={styles.descriptionTextStyle}>Ideal for business meetings, tourist travel</Text>
                        <Text style={styles.descriptionTextStyle}>and multiple stop trips</Text>
                    </View>
                </View>
                <View style={styles.descriptionContainer}>
            ...
            <TouchableOpacity style={styles.buttonContainer} onPress={() => navigation.navigate("RentalsGettingStarted")}>
